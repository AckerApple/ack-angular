...
import * as i1 from "./AckModal.component.ngfactory";
...
import * as i6 from "./AckOptionsModal.component";
var styles_AckOptionsModal = [];
var RenderType_AckOptionsModal = i0.ɵcrt({ encapsulation: 2, styles: styles_AckOptionsModal, data: {} });
export { RenderType_AckOptionsModal as RenderType_AckOptionsModal };
export function View_AckOptionsModal_0(_l) { return i0.ɵvid(0, [(_l()(), i0.ɵeld(0, 0, null, null, 7, "ack-modal", [], null, [[null, "close"], [null, "showModelChange"], [null, "backgroundColorChange"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("close" === en)) {
        ...
        ad = (pd_2 && ad);
    } return ad; }, i1.View_AckModal_0, i1.RenderType_AckModal)), i0.ɵdid(1, 245760, null, 1, i2.AckModal, [i0.ElementRef, i3.AckApp], { isModelMode: [0, "isModelMode"], allowClose: [1, "allowClose"], wrapStyle: [2, "wrapStyle"], wrapCellStyle: [3, "wrapCellStyle"], backgroundColor: [4, "backgroundColor"], showModel: [5, "showModel"] }, { showModelChange: "showModelChange", close: "close" }), i0.ɵqud(603979776, 1, { body: 0 }), i0.ɵncd(0, 0), (_l()(), i0.ɵeld(4, 0, null, 0, 3, "div", [["class", "border-grey-6x border bg-white"]], null, null, null, null, null)), (_l()(), i0.ɵeld(5, 0, null, null, 2, "ack-options", [], null, [[null, "modelChange"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("modelChange" === en)) {
...
export function View_AckOptionsModal_Host_0(_l) { return i0.ɵvid(0, [(_l()(), i0.ɵeld(0, 0, null, null, 2, "ack-options-modal", [], null, null, null, View_AckOptionsModal_0, RenderType_AckOptionsModal)), i0.ɵdid(1, 4243456, null, 1, i6.AckOptionsModal, [i0.ElementRef], null, null), i0.ɵqud(603979776, 1, { templateRefs: 1 })], null, null); }
...
export { AckOptionsModalNgFactory as AckOptionsModalNgFactory };
//# sourceMappingURL=AckOptionsModal.component.ngfactory.js.map