(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('ack-angular-fx'), require('ack-x/browser'), require('rxjs/internal/BehaviorSubject'), require('@angular/platform-browser'), require('@angular/router'), require('@angular/common/http'), require('localforage')) :
    typeof define === 'function' && define.amd ? define('ack-angular', ['exports', '@angular/core', '@angular/common', 'ack-angular-fx', 'ack-x/browser', 'rxjs/internal/BehaviorSubject', '@angular/platform-browser', '@angular/router', '@angular/common/http', 'localforage'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ack-angular'] = {}, global.ng.core, global.ng.common, global.ackAngularFx, global.browser, global.rxjs['internal/BehaviorSubject'], global.ng.platformBrowser, global.ng.router, global.ng.common.http, global.localForage));
}(this, (function (exports, core, common, ackAngularFx, browser, BehaviorSubject, platformBrowser, router, http, localForage) { 'use strict';
    ...
    */
    ...
    var AckQue = /** @class */ (function (_super) {
        ...
        */
        ...
        AckQue.prototype.processAllQues = function () {
            var _this = this;
            var promises = [];
            this.handlers.forEach(function (hand) { return promises.push(_this.processQuedHandler(hand)); });
    ...
    var AckApi = /** @class */ (function () {
        function AckApi(HttpClient) {
            ...
            this.Request = new core.EventEmitter();
            this.AuthError = new core.EventEmitter();
            this.ApiError = new core.EventEmitter();
        ...
        */
        AckApi.prototype._fetch = function (cfg) {
            ...
            if (cfg.params) {
                cfgPlus.params = new http.HttpParams({
                    fromObject: cfg.params
                });
            }
            if (cfg.headers) {
                cfgPlus.headers = new http.HttpHeaders(cfg.headers);
            }
            var request = new http.HttpRequest(cfg.method, cfg.url, cfg.body, cfgPlus);
