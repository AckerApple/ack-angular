    ...
    */
    ...
    var ContentModel = /** @class */ (function () {
        function ContentModel(elm) {
            ...
            this.hasFocusChange = new core.EventEmitter(); // fires when enter key used
    ...
    ContentModel.propDecorators = {
        ...
        hasFocusChange: [{ type: core.Output }],
