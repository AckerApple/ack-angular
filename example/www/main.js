...
var ScreenHeightModel = /** @class */ (function () {
    ...
    ScreenHeightModel.prototype.ngAfterViewInit = function () {
        var _this = this;
        setTimeout(function () { return _this.setModel(_this.HtmlSizeService.htmlSize); }, 0); //two way bind often needs init override
        //content may grow
        //setTimeout(()=>this.changed(), 200)//two way bind often needs init override
    };
