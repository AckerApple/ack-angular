...
export declare class AckSections {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AckSections, "ack-sections", never, { "mode": "mode"; "zIndex": "zIndex"; }, {}, ["table", "headerWrap", "bodyCell", "leftBodyWrap", "rightBodyWrap"], ["*"], false>;
}
