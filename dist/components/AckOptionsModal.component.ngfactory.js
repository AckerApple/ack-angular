...
const i1 = require("./AckModal.component.ngfactory");
const i2 = require("./AckModal.component");
const i3 = require("../providers/AckApp.provider");
const i4 = require("./AckOptions.component.ngfactory");
const i5 = require("./AckOptions.component");
const i6 = require("./AckOptionsModal.component");
