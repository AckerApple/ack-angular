...
*/
var UiRouteWatchReporter = (function () {
    function UiRouteWatchReporter(StateService, TransitionService) {
        var _this = this;
    ...
    UiRouteWatchReporter.prototype.isTrapHistory = function (toState, toParams) {
        return this.isBackHistory(toState, toParams) && this.isForwardHistory(toState, toParams);
    };
    UiRouteWatchReporter.prototype.isBackHistory = function (toState, toParams) {
    ...
    UiRouteWatchReporter.prototype.isForwardHistory = function (toState, toParams) {
        //const $history = this.$history()
        var $history = this.$history;
    ...
    UiRouteWatchReporter.prototype.isParamsMatch = function (toParams, otherParams) {
    ...
    */
    ...
    UiRouteWatchReporter.prototype.recordStateChange = function (toState, toParams) {
    ...
    UiRouteWatchReporter.prototype.goBackTo = function (name, params) {
        this.isNextBackMode = true;
        this.isNextBackHistory = true;
        this.$state().go(name, params);
    };
    UiRouteWatchReporter.prototype.tryBack = function (name, params) {
    ...
    UiRouteWatchReporter.prototype.watchDocument = function ($document) {
        this.watchDocByCallbacks($document, this.getDocumentCallbacks());
    };
    UiRouteWatchReporter.prototype.getDocumentCallbacks = function () {
        var _this = this;
    ...
    UiRouteWatchReporter.prototype.watchDocByCallbacks = function ($document, callbacks) {
    ...
    UiRouteWatchReporter.prototype.unwatchDocByCallbacks = function ($document, callbacks) {
    ...
    return UiRouteWatchReporter;
}());
UiRouteWatchReporter.parameters = [[ui_router_ng2_1.StateService], [ui_router_ng2_1.TransitionService]];
exports.UiRouteWatchReporter = UiRouteWatchReporter;
//# sourceMappingURL=UiRouteWatchReporter.class.js.map